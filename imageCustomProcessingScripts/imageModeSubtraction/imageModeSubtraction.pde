...
void draw() {
  ...
  subThem(); // this function add the red with red green with green blue with blue of the twoimages
...
//loop through all pixels in newA and assign RGB color to each pixel
 ...
 newA.pixels[loc] = color(Cr[loc], Ar[loc], Ab[loc]);
    }//end loop 1
  }//end loop 2
 ...
 newB.pixels[loc] = color(Cr[loc], Br[loc], Bb[loc]);
    }//end loop 1
  }//end loop 2
...
popMatrix();
 ...
 //save the images
  //save("newImageA_subRed.png");
  save("newImageB_subRed.png");
